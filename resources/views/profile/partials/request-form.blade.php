...
@if(!empty($user))
    ...
    <div class="flex flex-col  gap-2 justify-start" style="width: 70%;">
        ...
        <input style="background-color: #C0F3F7; width: 100%" class="border-none rounded-md" type="text" name="fName"
               id=""
               required placeholder="First name">
        <input style="background-color: #C0F3F7; width: 100%" class="border-none rounded-md" type="text" name="lName"
               id=""
        ...
        <input style="background-color: #C0F3F7; width: 100%" class="border-none rounded-md" type="text" name="email"
               id=""
               required placeholder="E-mail">
        <div class="relative" style="width: 100%">
            <div class="absolute inset-y-0 left-0 flex items-center pl-3 pointer-events-none">
                <svg aria-hidden="true" class="w-5 h-5 text-gray-500 dark:text-gray-400" fill="#4F9298"
                     viewBox="0 0 20 20"
...
@else
    <div>
        You can't make any appointments yet :( <br>
        Please Contact us with the information provided.
    </div>
@endif
